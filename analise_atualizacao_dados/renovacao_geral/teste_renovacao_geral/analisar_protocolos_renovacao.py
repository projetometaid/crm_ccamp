#!/usr/bin/env python3
"""
ANÁLISE SIMPLES DE PROTOCOLOS - RENOVAÇÃO GERAL
...
def ler_protocolos_arquivo():
    ...
    print("📖 LENDO PROTOCOLOS DO ARQUIVO RENOVAÇÃO...")
    ...
    for col in range(min(10, sheet.ncols)):  # Mostrar primeiros 10
...
def main():
    """Função principal"""
    print("🔍 ANÁLISE DE PROTOCOLOS - RENOVAÇÃO GERAL")
    print("=" * 50)
    print("🎯 Arquivo: GestaoRenovacao (1).xls")
